...
const filterPeople = () => people.filter(({ nationality, bornIn }) => nationality === 'Australian'
...
// 9 - Existe um objeto yearSeasons que representam as estações do ano. Cada estação é uma chave deste objeto 
// e o valor de cada chave é um array de strings, representando os meses daquela estação. A partir deste objeto, 
